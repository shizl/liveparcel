 ...
 day = (mydate.getDate()+parseInt(time_setting))<10?'0'+(mydate.getDate()+parseInt(time_setting)):(mydate.getDate()+parseInt(time_setting));
   var fulldate = month +"/"+day+"/"+mydate.getFullYear();
    ...
    if(isNaN(size_length)||parseFloat(size_length)<=0||size_length.length==0){
      alert('#parcel'+i+': length value must be Greater than 0');
      return false;
    }
    else if(isNaN(size_width)||parseFloat(size_width)<=0||size_width.length==0){
      alert('#parcel'+i+': width value must be Greater than 0');
      return false;
    }
    else if(isNaN(size_height)||parseFloat(size_height)<=0||size_height.length==0){
      alert('#parcel'+i+': height value must be Greater than 0');
      return false;
    }
    else if(isNaN(pweight)||parseFloat(pweight)<=0||pweight.length==0){
      alert('#parcel'+i+': weight value must be Greater than 0');
      return false;
    }
    else if(isNaN(cash)||parseFloat(cash)<=0||cash.length==0){
      alert('#parcel'+i+': cash to collect value must be Greater than 0');
      return false;
    }
    else if(jQuery('.form-item-pickup-time-date-'+i+' input').val()==""){
      alert('#parcel'+i+': date can not be empty');
      return false;
    }
    else if(date1>date2){
      ...
      alert('#parcel'+i+': pickup first name can not be empty');
      return false;
    }
    else if(jQuery('.form-item-pickup-last-name-'+i+' input').val()==""){
      alert('#parcel'+i+': pickup last name can not be empty');
      return false;
    }
    else if(jQuery('.form-item-delivery-first-name-'+i+' input').val()==""){
      alert('#parcel'+i+': delivery first name can not be empty');
      return false;
    }
    else if(jQuery('.form-item-delivery-last-name-'+i+' input').val()==""){
      alert('#parcel'+i+': delivery last name can not be empty');
      return false;
    }
