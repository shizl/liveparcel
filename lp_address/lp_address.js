...
function copy_package(parcelnum){
 ...
 pickup_date = parcelnum!=null?jQuery('fieldset .form-item-pickup-time-date-'+parcelnum+'-date input').val():'';
 pickup_ampm = parcelnum!=null?jQuery('fieldset .form-item-pick-up-time-ampm-'+parcelnum+' select').val():'';
 pickup_address = parcelnum!=null?jQuery('fieldset #edit-pickup-'+parcelnum+'-select-address').val():'';
 ...
 delivery_address = parcelnum!=null?jQuery('fieldset #edit-delivery-'+parcelnum+'-select-address').val():'';
